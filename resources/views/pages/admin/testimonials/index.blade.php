        ...
        <table class="min-w-full divide-y divide-gray-200 dark:border-dvide-bd text-sm">
            <thead class="bg-surface text-left">
                <tr>
                    ...
                    <th class="px-4 py-3">Cargo / Empresa</th>
            ...
            <tbody data-sortable-list data-resource="testimonials" class="divide-y divide-gray-200 dark:border-dvide-bd">
                @forelse($testimonials as $t)
                    <tr data-sortable-item data-id="{{ $t->id }}">
                        ...
                        <td class="px-4 py-3"><span data-sortable-position>{{ $t->position }}</span></td>
                ...
                @empty
                    <tr><td colspan="8" class="px-4 py-8 text-center text-gray-500">Nenhum depoimento cadastrado.</td></tr>
                @endforelse
            </tbody>
        </table>
    </div>
